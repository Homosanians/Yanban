...
///
/// <para>Enqueued by a database trigger on <c>AFTER DELETE ON attachments</c> — deliberately, not
...
public class ObjectDeletion
{
    ...
    /// <summary>The S3 key to delete. Copied by the trigger — the attachment row is already gone.</summary>
