...
///
/// <para>Resolution is most-specific-first: an override for <i>this board</i>, else the user's
/// global override, else the type's default. Only overrides are stored, so a user who has never
/// touched a toggle has no rows at all.</para>
/// </summary>
