...
/// is the plain newest-first feed the board has always had.
///
...
/// filter rather than a text match — "who did it" is a fact, not a search term, and matching a name
/// as text would also hit every card that happens to mention it.</para>
/// </summary>
